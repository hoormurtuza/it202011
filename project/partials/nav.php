...
<nav>
    ...
    <ul class="nav">
        ...
        <?php if (has_role("Admin")): ?>
            ...
            <li><a href="<?php echo getURL("test_create_product.php"); ?>">Create Product</a></li>

            <li><a href="<?php echo getURL("test_list_product.php"); ?>">View Products</a></li>            

            <li><a href="test_create_incubator.php">Create Incubator</a></li>
            <li><a href="test_list_incubator.php">View Incubator</a></li>
